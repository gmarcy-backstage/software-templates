...
IMPORTANT: Make sure to click on *`Grant`* next to the **rhdh23-lab** GitHub Org before approving Dev Spaces access (where _N_ matches your cluster's GitHub Org ID number).
...
* To learn about the Software Templates that were used in this workshop, visit: https://github.com/gmarcy/backstage-workshop

* For more Backstage / RHDH Software Templates examples, see: https://github.com/redhat-developer/red-hat-developer-hub-software-templates

* To share your feedback on this workshop, open an issue here: https://github.com/gmarcy/backstage-workshop/issues
